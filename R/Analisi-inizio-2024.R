...
dt2022 <- read_excel("dati/08012024 Elenco Campioni PRC 2021_006.xlsx",
                     sheet = "CAMPIONI PRC COVID 2022", col_types = c("numeric", "text", "text", "numeric", "text",
                                                                      "text", "skip", "text", "text", "date", "text",
                                                                      "date", "text", "text", "text", "skip"))

dt2023 <- read_excel("dati/08012024 Elenco Campioni PRC 2021_006.xlsx", 
                      sheet = "CAMPIONI PRC COVID 2023", col_types = c("numeric", "text", "text", "numeric", "text",
                                                                 "text", "text", "text", "date", "text",
                                                                 "date", "text", "text", "text", "skip"))
...
tab_pc %>% write.xlsx(file = here("2024.02.02 Summary positivi Pancov per specie.xlsx"))
